...
func (inst *NEW_ARRAY) FetchOperands(cr *utils.ByteCodeReader) {
	inst.atype = cr.ReadUint8()
}
...
func (inst *MULTI_ANEW_ARRAY) FetchOperands(cr *utils.ByteCodeReader) {
	inst.index = cr.ReadUint16()
	inst.dimension = cr.ReadUint8()
}
