...
func (cpInfo *ConstantUtf8Info) readInfo(reader *utils.ByteCodeReader) {
	length := uint32(reader.ReadUint16())
	bytes := reader.ReadBytes(length)
	cpInfo.str = decodeMUTF8(bytes)
}

func (cpInfo *ConstantUtf8Info) String() string {
	return cpInfo.str
}

// copied from jvmgo-book
